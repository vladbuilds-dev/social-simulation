...
// Порт model.py один в один: те же типы, профили, правила шага и метрики.
...
export class Simulation {
  ...
  step() {
    ...
    const n = net.n;
    const newRumor = new Uint8Array(n);
    const newCorr = new Uint8Array(n);
    ...
    for (let v = 0; v < n; v++) {
      if (newCorr[v]) this.adoptCorrection(v, corrSpread[v]);
      else if (newRumor[v] && this.message[v] === Opinion.NONE) this.adoptRumor(v);
    }
