...
export const LEVELS = [
  {
    ...
    scenario: { nNodes: 140, network: "scale_free", avgDegree: 6, pShare: 0.25, botFraction: 0.03, botPlacement: "random", nSteps: 40, seed: 33 },
  ...
  },
  {
    ...
    scenario: { nNodes: 150, network: "scale_free", avgDegree: 6, pShare: 0.22, botFraction: 0.03, botPlacement: "hubs", nSteps: 40, seed: 5 },
  ...
  },
  {
    ...
    scenario: { nNodes: 170, network: "scale_free", avgDegree: 6, pShare: 0.3, botFraction: 0.07, botPlacement: "random", skepticFraction: 0.1, nSteps: 40, seed: 21 },
    tools: { factchecker: 6, ban: 3 },
    stars: [0.2, 0.15, 0.11],
  },
];
